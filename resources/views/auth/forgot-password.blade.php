...
<head>
    ...
    <title>Forgot Password - Konnectix Software</title>
                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-xl-6 col-md-6 sign text-center">
                                <div>
                                    ...
                                    <img src="{{ asset('template/images/log.png') }}" class="img-fix bitcoin-img sd-shape7" alt="Forgot Password Illustration">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="sign-in-your py-4 px-2">
                                    ...
                                    <span>No worries! Enter your email address and we'll send you<br> a link to reset your password.</span>
                                    
                                    <!-- Success Message -->
                                    @if (session('status'))
                                        <div class="alert alert-success alert-dismissible fade show mt-3">
                                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="me-2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
