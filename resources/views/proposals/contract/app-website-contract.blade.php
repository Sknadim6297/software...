...
<head>
    ...
    <title>{{ strtoupper($proposal->project_title ?? 'WEBSITE DEVELOPMENT') }} CONTRACT</title>
    <style>
            ...
            <div class="agreement-content">
                @php
                    ...
                    if (empty($content)) {
                        ...
                        // Reconstruct the full contract content
                        $content = "# " . strtoupper($projectTitle) . " CONTRACT\n\n";
                        $content .= "This Contract is made on " . date('d.m.Y') . "\n\n";
                        ...
                        $content .= "## 1. PURPOSE OF THE CONTRACT\n\n";
                        $content .= "The purpose of this Contract is to define the terms and conditions under which the Service Provider shall design and develop a " . $projectTitle . " for the Client.\n\n";
                        ...
                        $content .= "- Either Party may terminate this Contract with written notice\n";
                        ...
                        $content .= "This Contract shall be governed by and construed in accordance with the laws of India, and courts of Kolkata shall have exclusive jurisdiction.\n\n";
                        
                        $content .= "## 12. ENTIRE AGREEMENT\n\n";
                        $content .= "This Contract constitutes the entire understanding between the Parties and supersedes all prior discussions or communications.\n";
