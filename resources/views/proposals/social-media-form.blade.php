...
function previewProposal() {
    ...
    const monthlyCharges = formData.get('monthly_charges') || '19000';
    ...
    const previewHTML = `
        <div class="proposal-preview" style="font-family: Arial, sans-serif; max-width: 800px;">
            ...
            <div class="mb-4">
                <h5 class="text-success">Monthly Charges</h5>
                <div class="alert alert-success">
                    <h4>Total Monthly Fee: ₹${parseInt(monthlyCharges).toLocaleString()}/-</h4>
                    <p class="mb-0">
